package com.polygon {
	public class Sweep {
		...
		public function edgeEventByPoints(ep:Point, eq:Point, triangle:Triangle, point:Point):void {
			...
			if (o1 == Orientation.COLLINEAR) throw(new Error('Sweep.edgeEvent: Collinear not supported!'));

			var p2:Point = triangle.pointCW(point);
			var o2:int   = Orientation.orient2d(eq, p2, ep);
			if (o2 == Orientation.COLLINEAR) throw(new Error('Sweep.edgeEvent: Collinear not supported!'));
